...
debug: build
	opam exec -- ocamldebug _build/default/gocaml/main.bc

DOCS_PATH=docs/
DOCS_NAME=gocaml
DOCS_DESCR=An OCaml Go Engine
...
<meta content="https://github.com/CharlesAverill/gocaml" property="og:url" />
endef
...
docs: cleandocs build
	...
	mv $(DOCS_PATH)gocaml/gocaml.html $(DOCS_PATH)index.html
	mv $(DOCS_PATH)gocaml $(DOCS_PATH)module
